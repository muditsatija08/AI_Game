...
def get_targets(ink_x, ink_y, clyd_x, clyd_y):
    if player_x < 450:
        runaway_x = 900
    else:
        runaway_x = 0
...
while run:
    ...
    #                blinky_box, 0)
    inky = Ghost(inky_x, inky_y, targets[0], ghost_speeds[0], inky_img, inky_direction, inky_dead,
                 inky_box, 1)
    # pinky = Ghost(pinky_x, pinky_y, targets[2], ghost_speeds[2], pinky_img, pinky_direction, pinky_dead,
    #               pinky_box, 2)
    clyde = Ghost(clyde_x, clyde_y, targets[1], ghost_speeds[1], clyde_img, clyde_direction, clyde_dead,
                  clyde_box, 3)
    draw_misc()
    # targets = get_targets(blinky_x, blinky_y, inky_x, inky_y, pinky_x, pinky_y, clyde_x, clyde_y)
    targets = get_targets(inky_x, inky_y, clyde_x, clyde_y)
